...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/calculator156.png">
    ...
    <title>Monthly Academic Transaction History</title>
        ...
        <!--=================================================== site1 ===================================================-->
              ...
              <div id="g-site1" class="col-xs-12">
                  <div class="demo-container">
					<strong><h3><center>Monthly Academic Transaction History</center></h3></strong>
						<div id="block_bg" class="block">	
                            <div class="navbar navbar-inner block-header">
                            <div class="block-content collapse in">
                                <div class="span12">
								<form method="POST" action="view_transm.php">
								<center><table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									<tr>
									<th>Enter the Month:<td><input type="month" name="month" /><p><p>
									<tr>	
