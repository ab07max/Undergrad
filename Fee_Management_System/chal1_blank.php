...
<div style="position:absolute;left:100px;top:177px" class="cls_003"><span class="cls_003">EAMCET:<input type="text"readonly name="sid"value="<?php echo $roll;?>" id="rollid1" style="border: none;font-size: 15px;width: 95px;text-align:center;font-weight:bold" onchange="changeroll()"></span></div>
...
<div style="position:absolute;left:447px;top:177px" class="cls_003"><span class="cls_003">EAMCET:<input type="text"readonly name="sid"value="<?php echo $roll;?>" id="rollid2" style="border: none;font-size: 15px;width: 95px;text-align:center;font-weight:bold" ></span></div>
...
<div style="position:absolute;left:797px;top:177px" class="cls_003"><span class="cls_003">EAMCET:<input type="text"readonly name="sid" value="<?php echo $roll;?>"id="rollid3" style="border: none;font-size: 15px;width: 95px;text-align:center;font-weight:bold" ></span></div>
...
<div style="position:absolute;left:10.00px;top:423px" class="cls_003"><span class="cls_003">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number"readonly name="total" id="totalid1" value="<?php echo $total;?>"style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline;font-weight:bold" ></span></div>
<div style="position:absolute;left:357.00px;top:423px" class="cls_003"><span class="cls_003">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number"readonly name="total" id="totalid2" value="<?php echo $total;?>"style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline;font-weight:bold" ></span></div>
<div style="position:absolute;left:707px;top:423px" class="cls_003"><span class="cls_003">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number"readonly name="total" id="totalid3" value="<?php echo $total;?>"style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline;font-weight:bold" ></span></div>
