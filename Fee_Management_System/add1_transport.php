<?php
	...
	session_start();
	$roll=$_REQUEST['roll'];
	$sql="select * from student_transport where roll='$roll'";
	$query=mysql_query($sql);
	$count=mysql_num_rows($query);
	if($count==0){
?>
<script>
	alert("No Record Found in the database, add the Transport Details first!");
	window.location="add_transport.php";
</script>	
<?php	
	}
	else{
		...
		<div class="col-md-12">
			...
			<div>
					...
					<div class="form-group">
							  ...
							  <div class="col-md-3">
					<input type="text" name="routeno" value="<?php echo $row['routeno'];?>"id = "lname" class="form-control input-md" placeholder="Branch" required/> 
					</div>
					</div>
				<div class="form-group">
				...
				if(isset($_REQUEST['update'])){
					...
					$update="update student_transport set roll='$roll',name='$name',routeno='$routeno',feedue='$feedue' where roll='$roll'";
					mysql_query($update);
?>
<script>
