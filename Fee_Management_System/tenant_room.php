                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										<tbody>
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to View." href="search1.php">Search Student</a></center></td>
									<?php
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to View." href="view_tenant.php<?php echo '?id='.$row['room_id'];?>">View Student</a></center></td>
											</center>
