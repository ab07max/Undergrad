    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
               ...
               <div class="span3">&nbsp;&nbsp;&nbsp;&nbsp;<img class="index_logo" height="45" width="100" src0000000="assets/img/logosmall1666.png"></div>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="updatest.php"><i class="glyphicon glyphicon-import"></i>&nbsp; Update Student Details</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul id="demons" class="collapse">
                            <li>
                                <a href="generate.html" class="glyphicon glyphicon-eye-open">&nbsp;Fee Chalan</a>
                            </li>
                            <li>
                                <a href="generate_transport.html" class="glyphicon glyphicon-eye-open">&nbsp;Transport Chalan</a>
                            </li>
                        </ul>
                    </li>
