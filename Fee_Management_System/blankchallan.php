...
<form name="forms" method="POST" action="blank_final.php">
...
<div style="position:absolute;left:10.00px;top:150px" class="cls_003"><span class="cls_003">Name of the Student <input type="text" id="snameid1" value="" name="sname" placeholder="Enter" style="border: none;font-size: 15px;width: 200px;text-align:center;font-weight:bold" pattern="[a-zA-Z ]+"oninvalid="setCustomValidity('Plz enter on Alphabets ')" onchange="try{setCustomValidity('')}catch(e){}" style="border: none;font-size: 15px;width: 200px;text-align:center" oninput="changename()" ></span></div>
<div style="position:absolute;left:357.05px;top:150px" class="cls_003"><span class="cls_003">Name of the Student <input type="text" id="snameid2" value="" name="sname" style="border: none;font-size: 15px;width: 200px;text-align:center;font-weight:bold" oninput="changename()" ></span></div>
<div style="position:absolute;left:707px;top:150px" class="cls_003"><span class="cls_003">Name of the Student <input type="text" id="snameid3" value="" name="sname"  style="border: none;font-size: 15px;width: 200px;text-align:center;font-weight:bold" oninput="changename()" ></span></div>
<div style="position:absolute;left:10.00px;top:177px" class="cls_003"><span class="cls_003">D.D:<input type="text" name="sclass" id="classid1" placeholder="Enter" style="border: none;font-size: 15px;width: 50px;text-align:center;font-weight:bold" oninput="changeclass()" ></span></div>
<div style="position:absolute;left:100px;top:177px" class="cls_003"><span class="cls_003">EAMCET:<input type="text" name="sid" id="rollid1"value="" placeholder="Enter" style="border: none;font-size: 15px;width: 95px;text-align:center;font-weight:bold" oninput="changeroll()"></span></div>
<div style="position:absolute;left:245px;top:177px" class="cls_003"><span class="cls_003">Branch<input type="text" name="sbranch" id="branchid1" value="" placeholder="Enter" style="border: none;font-size: 15px;width: 55px;text-align:center;font-weight:bold" oninput="changebranch()" ></span></div>
...
<div style="position:absolute;left:447px;top:177px" class="cls_003"><span class="cls_003">EAMCET:<input type="text" name="sid" id="rollid2" value=""  oninput="changeroll()"style="border: none;font-size: 15px;width: 95px;text-align:center;font-weight:bold" ></span></div>
<div style="position:absolute;left:598px;top:177px" class="cls_003"><span class="cls_003">Branch<input type="text" name="sbranch" id="branchid2"value="" oninput="changebranch()"style="border: none;font-size: 15px;width: 55px;text-align:center;font-weight:bold" ></span></div>
...
<div style="position:absolute;left:797px;top:177px" class="cls_003"><span class="cls_003">EAMCET:<input type="text" name="sid" id="rollid3" value="" oninput="changeroll()"style="border: none;font-size: 15px;width: 95px;text-align:center;font-weight:bold"  ></span></div>
<div style="position:absolute;left:948px;top:177px" class="cls_003"><span class="cls_003">Branch <input type="text" name="sbranch" id="branchid3"value="" oninput="changebranch()" style="border: none;font-size: 15px;width: 55px;text-align:center;font-weight:bold" ></span></div>
...
<div style="position:absolute;left:10.00px;top:320px" class="cls_003"><span class="cls_003">l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TUTION FEE                 DUE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="univ" id="univid1"  value="0" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:357px;top:320px" class="cls_003"><span class="cls_003">l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TUTION FEE                 DUE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="univ" id="univid2" value="0" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:707px;top:320px" class="cls_003"><span class="cls_003">l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TUTION FEE                 DUE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="univ" id="univid3" value="0" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>

<div style="position:absolute;left:10px;top:340px" class="cls_003"><span class="cls_003">l l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ACCRED. FEE                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="acc" id="accid1"  value="0"placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:357px;top:340px" class="cls_003"><span class="cls_003">l l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ACCRED. FEE                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="acc" id="accid2" value="0" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:707px;top:340px" class="cls_003"><span class="cls_003">l l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ACCRED. FEE                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="acc" id="accid3" value="0" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>

<div style="position:absolute;left:10px;top:360px" class="cls_003"><span class="cls_003">l l l&nbsp;&nbsp;&nbsp;MISC. FEE                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="misc" id="miscid1"value="0"  placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:357px;top:360px" class="cls_003"><span class="cls_003">l l l&nbsp;&nbsp;&nbsp;MISC. FEE                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="misc" id="miscid2"  value="0"placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:707px;top:360px" class="cls_003"><span class="cls_003">l l l&nbsp;&nbsp;&nbsp;MISC. FEE                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="misc" id="miscid3"  value="0"placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
...
<div style="position:absolute;left:10.00px;top:423px" class="cls_003"><span class="cls_003">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="total" id="totalid1" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline;font-weight:bold" ></span></div>
<div style="position:absolute;left:357.00px;top:423px" class="cls_003"><span class="cls_003">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="total" id="totalid2" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline;font-weight:bold" ></span></div>
<div style="position:absolute;left:707px;top:423px" class="cls_003"><span class="cls_003">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="total" id="totalid3" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline;font-weight:bold" ></span></div>
