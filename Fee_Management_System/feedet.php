<?php
	...
	$sql="select * from student where roll='$myusername'";
        ...
        <!--=================================================== site1 ===================================================-->
              ...
              <div id="g-site1" class="col-xs-12">
                  <div class="demo-container">
					<strong><h1><center>Fee Details</center></h1></strong>
						<div id="block_bg" class="block">	
                            ...
                            <div class="block-content collapse in">
								...
								<center><table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									<h3>		
									<tr>
										<th>Fee:<td><?php echo $row['fee'];?><p><p><p>
									<tr>
										<th>Fee due<td><?php echo $row['feedue'];?>
									</h3>
								</table>
								</center>
