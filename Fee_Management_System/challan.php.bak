...
<div style="position:absolute;left:10.00px;top:15px" class="cls_002"><span class="cls_002">Account No. ABC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TRIPLICATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Account No. ABC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DUPLICATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Account No. ABC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ORIGINAL</span></div> 
<div style="position:absolute;left:10px;top:42px" class="cls_003"><span class="cls_003">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(TO BE RETAINED BY THE BANK)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(TO BE RETAINED BY THE DEPT)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(TO BE RETAINED BY THE STUDENT)</span></div>
<div style="position:absolute;left:10.00px;top:69px" class="cls_003"><span class="cls_003">Challan No.<input type="text" name="challan" id="cid1" value="<?php echo $r['chalanno'];?>" style="border: none;width: 100px;text-align:center" ></span></div>
<div style="position:absolute;left:162.9px;top:69px" class="cls_003"><span class="cls_003">DATE:<input type="text" name="date" id="dateid1" style="border: none;width: 150px;text-align:center" ></span></div>
<div style="position:absolute;left:360px;top:69px" class="cls_003"><span class="cls_003">Challan No.<input type="text" name="challan" id="cid2" value="<?php echo $r['chalanno'];?>" style="border: none;width: 100px;text-align:center" ></span></div>
<div style="position:absolute;left:510px;top:69px" class="cls_003"><span class="cls_003">DATE:<input type="text" name="date" id="dateid2" style="border: none;width: 150px;text-align:center" ></span></div>
<div style="position:absolute;left:710px;top:69px" class="cls_003"><span class="cls_003">Challan No.<input type="text" name="challan"id="cid3" value="<?php echo $r['chalanno'];?>"style="border: none;width: 100px;text-align:center" ></span></div>
<div style="position:absolute;left:860px;top:69px" class="cls_003"><span class="cls_003">DATE:<input type="text" name="date" id="dateid3"  style="border: none;width: 150px;text-align:center" ></span></div>
...
<div style="position:absolute;left:10.00px;top:150px" class="cls_003"><span class="cls_003">Name of the Student <input type="text" id="snameid1" value="<?php $_SESSION['n']=$row['name'];echo $row['name'];?>" name="sname" placeholder="Enter" pattern="[a-zA-Z ]+"
...
<div style="position:absolute;left:357.05px;top:150px" class="cls_003"><span class="cls_003">Name of the Student <input type="text" id="snameid2" value="<?php echo $row['name'];?>" name="sname" style="border: none;font-size: 15px;width: 200px;text-align:center" ></span></div>
<div style="position:absolute;left:707px;top:150px" class="cls_003"><span class="cls_003">Name of the Student <input type="text" id="snameid3" value="<?php echo $row['name'];?>" name="sname"  style="border: none;font-size: 15px;width: 200px;text-align:center" ></span></div>
<div style="position:absolute;left:10.00px;top:177px" class="cls_003"><span class="cls_003">Class:<input type="text" name="sclass" id="classid1" style="border: none;font-size: 15px;width: 50px;text-align:center" onchange="changeclass()" ></span></div>
<div style="position:absolute;left:100px;top:177px" class="cls_003"><span class="cls_003">Roll No.<input type="text" name="sid" id="rollid1"value="<?php echo $row['roll'];?>" placeholder="Enter" style="border: none;font-size: 15px;width: 95px;text-align:center" onchange="changeroll()"></span></div>
<div style="position:absolute;left:245px;top:177px" class="cls_003"><span class="cls_003">Branch<input type="text" name="sbranch" id="branchid1" value="<?php $_SESSION['branch']=$row['branch'];echo $row['branch'];?>"placeholder="Enter" style="border: none;font-size: 15px;width: 55px;text-align:center" onchange="changebranch()" ></span></div>
<div style="position:absolute;left:357px;top:177px" class="cls_003"><span class="cls_003">Class <input type="text" name="sclass" id="classid2" style="border: none;font-size: 15px;width: 50px;text-align:center" ></span></div>
<div style="position:absolute;left:447px;top:177px" class="cls_003"><span class="cls_003">Roll No.<input type="text" name="sid" id="rollid2" value="<?php echo $row['roll'];?>"style="border: none;font-size: 15px;width: 95px;text-align:center" ></span></div>
<div style="position:absolute;left:598px;top:177px" class="cls_003"><span class="cls_003">Branch<input type="text" name="sbranch" id="branchid2"value="<?php $_SESSION['branch']=$row['branch'];echo $row['branch'];?>"style="border: none;font-size: 15px;width: 55px;text-align:center" ></span></div>
<div style="position:absolute;left:707px;top:177px" class="cls_003"><span class="cls_003">Class  <input type="text" name="sclass" id="classid3"style="border: none;font-size: 15px;width: 50px;text-align:center" ></span></div>
<div style="position:absolute;left:797px;top:177px" class="cls_003"><span class="cls_003">Roll No.<input type="text" name="sid" id="rollid3" value="<?php echo $row['roll'];?>"style="border: none;font-size: 15px;width: 95px;text-align:center"  ></span></div>
<div style="position:absolute;left:948px;top:177px" class="cls_003"><span class="cls_003">Branch <input type="text" name="sbranch" id="branchid3"value="<?php $_SESSION['branch']=$row['branch'];echo $row['branch'];?>" style="border: none;font-size: 15px;width: 55px;text-align:center" ></span></div>
...
<div style="position:absolute;left:10.00px;top:342px" class="cls_003"><span class="cls_003">l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UNIVERSITY FEE DUE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="univ" id="univid1"  value="<?php echo $row['feedue'];?>" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:357px;top:342px" class="cls_003"><span class="cls_003">l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UNIVERSITY FEE DUE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="univ" id="univid2" value="<?php echo $row['feedue'];?>" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:707px;top:342px" class="cls_003"><span class="cls_003">l&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UNIVERSITY FEE DUE&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="univ" id="univid3" value="<?php echo $row['feedue'];?>" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:10.00px;top:369px" class="cls_003"><span class="cls_003">l l &nbsp;&nbsp;LATE FEE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="late" id="ltfid1" value="" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:357px;top:369px" class="cls_003"><span class="cls_003">l l &nbsp;&nbsp;LATE FEE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="late" id="ltfid2" value="" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:707px;top:369px" class="cls_003"><span class="cls_003">l l &nbsp;&nbsp;LATE FEE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="late" id="ltfid3" value="" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:10.00px;top:396px" class="cls_003"><span class="cls_003">l l l ANY OTHER FEE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="misc" id="miscid1" value="" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:357px;top:396px" class="cls_003"><span class="cls_003">l l l ANY OTHER FEE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="misc" id="miscid2" value="" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
<div style="position:absolute;left:707px;top:396px" class="cls_003"><span class="cls_003">l l l ANY OTHER FEE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="misc" id="miscid3" value="" placeholder="Enter" style="border: none;font-size: 15px;width: 100px;text-align:center;text-decoration: underline" ></span></div>
