        ...
        <!--=================================================== site1 ===================================================-->
              ...
              <div id="g-site1" class="col-xs-12">
                  <div class="demo-container">
                    <strong><h3><center>Generate Transport Fee Challan </center></h3></strong>
                        <div id="block_bg" class="block">   
                            <div class="navbar navbar-inner block-header">
                            <div class="block-content collapse in">
                                <div class="span12">
                                <form method="POST" action="challan_transport.php">
                                <center><table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                    <tr>
                                    <th>Enter the student Roll Number:<td><input type="text" name="rollno"><p><p>
                                    <tr>    
