...
<div class="received textboid"style="position:absolute;left:415.00px;top:58px" class="cls_002"><input name="stuid" id="stuid" type="text" style="border:none;text-align:center" placeholder="Enter"></input></div>
...
<div class="Received with"	 style="position:absolute;left:240.00px;top:85px" class="cls_002"><span class="cls_002"><input id="stuname"  name="stuname" type="text" style="width:340px" readonly style="border:none"></input></span></div>
...
<div class="sum in words"	 style="position:absolute;left:240.00px;top:158px" class="cls_002"><span class="cls_002"><input type="text" style="width:342px;" id="wordstwo" name="wordstwo" style="border:none" ></span></div>
...
<div class="toards type"	 style="position:absolute;left:300.00px;top:228px" class="cls_002"><span class="cls_002"><input type="text" name="type" id="type" style="width:400px" value="<?php ?>" required style="border:none" ></span></div>
