        ...
        <!--=================================================== site1 ===================================================-->
              ...
              <div id="g-site1" class="col-xs-12">
                  <div class="demo-container">
					<strong><h3><center>Generate Fee Challan </center></h3></strong>
						<div id="block_bg" class="block">	
                            ...
                            <div class="block-content collapse in">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									<tr>
									<th>Enter the student Roll Number:</th><td><input type="text" name="rollno"></td> <td><input type="submit" value="OK"></td>
									</tr>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									<tr>
									<td><form action="blankchallan.php"> <input type="submit" value="Generate Blank Chalan"></form></td>
									</tr>
								</table>
								</center>
								</div>
