<?php
	...
	$wrd=$_REQUEST['wrd'];
	$_SESSION['wrd']=$wrd;
	//echo $ch," ",$class," ",$roll," ",$date," ",$amount," ",$univ," ",$accred," ",$misc," ",$late," ",$readd;
	$sql="INSERT INTO `freshers`(`chalanno`, `ddno`, `rank`, `day`, `fee`, `accred`, `anyother`, `late`, `readd`) VALUES ('$ch','$class','$roll','$date','$univ','$accred','$misc','$late','$readd')";
	mysql_query($sql);
	/*$ch=$ch+1;
...
<script>
	...
	window.location = "chal1_blank.php";
</script>
<?php
	}?>	
