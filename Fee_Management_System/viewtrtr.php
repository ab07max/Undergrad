...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/calculator156.png">
    ...
    <title>Transport Transaction History</title>
        ...
        <!--=================================================== site1 ===================================================-->
              ...
              <div id="g-site1" class="col-xs-12">
                  <div class="demo-container">
					<strong><h3><center>Transport Transaction History</center></h3></strong>
						<div id="block_bg" class="block">	
                            <div class="navbar navbar-inner block-header">
                            <div class="block-content collapse in">
                                <div class="span12">
								<form method="POST" action="view_transport.php">
								<center><table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									<tr>
									<th>Enter the date:<td><input type="date" name="dateFrom" value="<?php echo date('Y-m-d');?>" /><p><p>
									<tr>	
									<td> <td align="right"><input type="submit" value="OK" name="view">
								</table>
								</center>
								</form>
								</div>
