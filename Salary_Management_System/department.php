<?php
	...
	$year=$_SESSION['year'];
	$dept=$_SESSION['dept'];
	$sql="select * from salary where (department='$dept' and year='$year' and month='$month')";
...
?>
<script>
	alert("Records of that department in the corresponding month and year doesn't exist in DB!");
 ...
 <?php
		while($row=mysqli_fetch_array($query,MYSQLI_ASSOC)){
			...
			a:{
				...
				$c=mysqli_fetch_array($b,MYSQLI_ASSOC);
				$sno=$c['max(sno)'];
				$sl="select * from salary where (fid='$fid' and year='$year' and month='$month' and sno='$sno')";
...
<tr>
		...
		<td align="left"><?php echo $deduction;?></td>
<tr align="center">
		<th height="35" colspan="4">Net Pay Rs:<?php echo $net;?></th>
	<tr>
			<td colspan="4" align="center"><b>LEAVES</b></br>
			<?php 
				if($casual!=0)
...
<tr align="center">
		<th colspan="4">Net Pay Rs:<?php echo $net;?></th>
