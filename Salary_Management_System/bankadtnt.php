<?php
	...
	$count=1;
	$i=0;
	$s="select * from salary where (year='$year' and month='$month' and type='Adhoc' and (stream='teaching' or stream='nonteaching'))";
...
<tr><th colspan=6 align="center">Bank Statement of Salaries of Adhoc Teaching and Non Teaching Staff </br> for the month of : &nbsp;&nbsp; <?php echo $month," , ",$year;?>
