...
<table border=1 style="border-collapse:collapse;" class="table2excel" >
 ...
 <tr><th colspan="4" align="center" >Statement of Professional Tax deducted from the Salaries of Staff for the month of :&nbsp;<?php echo $month," , ",$year;?></th></tr>
 ...
 <?php
	...
	$fid=$row['fid'];
	$professionaltax=$professionaltax+$row['professionaltax'];
...
?>
<tr><td align="center"><?php echo $i;?><td><?php echo $ro['name'];?><td><?php echo $ro['designation'];?><td><?php echo $row['professionaltax'];?>	
<?php
		$i=$i+1;
	}	
	...
	while($row=mysqli_fetch_array($query,MYSQLI_ASSOC)){
	$fid=$row['fid'];
	$professionaltax=$professionaltax+$row['professional'];
	$s="select * from details where fid='$fid'";
	$que=mysqli_query($con,$s);
	$ro=mysqli_fetch_array($que,MYSQLI_ASSOC);
...
?>
<tr><td align="center"><?php echo $i;?><td><?php echo $ro['name'];?><td><?php echo $ro['designation'];?><td><?php echo $row['professional'];?>	
<?php
		$i=$i+1;
	}	
...
?>
<tr><td align="center"><?php echo $i;?><td><?php echo $ro['name'];?><td><?php echo $ro['designation'];?></td><td> <?php echo $row['professional'];?></td>	
<?php
		$i=$i+1;
	}	
?>

<tr><td colspan="3" align="right" style="font-weight:bold">Total</td><td style="font-weight:bold"><input type="text" onclick="y()" id="incometax" value="<?= $professionaltax; ?>" style="width:100px;border:none" readonly> </td></tr>
