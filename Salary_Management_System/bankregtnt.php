<?php
	...
	$count=1;
	$i=0;
	$s="select * from salary where (year='$year' and month='$month' and type='Regular' and (stream='teaching' or stream='nonteaching'))";
...
<tr><th colspan=6 align="center">Bank Statement of Salaries of Regular Teaching and Non Teaching Staff </br> for the month of : &nbsp;&nbsp; <?php echo $month," , ",$year;?>
...
?>
<tr><td><?php echo $count;?><td width="200px"><?php echo $row['name'];?><td width="100px"><?php echo $row['designation'];?><td width="70px"><?php $accountno=(string)$row['account']; echo $accountno;?><td width="70px"><?php echo $row['pan'];?><td width="70px"><?php echo $z['netpay'];?>
<?php
			$count=$count+1;
			continue;
		}	
