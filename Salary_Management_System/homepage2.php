      ...
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/1.jpg)">
          <div class="caption" align="left">
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="add1.php" style="width:320px">Add Administrator</a></br>
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="monthly.php" style="width:320px">Consolidated Salary Statements</a></br>
            </br>
            </br>
            </br>
          </div>
