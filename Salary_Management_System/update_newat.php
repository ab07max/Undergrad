      ...
      <div class="container">
        ...
        <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="row">
			...
			<tr>
				<th >50%Bp:</th><td colspan="2"><input type="text" required  class="form-control" id="bp" name="bp" oninput="sum()"></td>
...
$(document).on("keypress", 'form', function (e) {
  ...
  <?php
	if(isset($_REQUEST['save'])){
		...
		$sal="INSERT INTO `salary`(`sno`, `fid`, `year`, `month`, `department`, `type`, `stream`, `account`, `grosspay`, `deductions`, `netpay`) VALUES ('','$fid','$year','$month','$dept','Adhoc','teaching','$acc','$gross','$deductions','$netpay')";
