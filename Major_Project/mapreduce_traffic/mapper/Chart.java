...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(noagg,"No Aggregation","No Aggregation");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Technique Name", "Processing Time", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
